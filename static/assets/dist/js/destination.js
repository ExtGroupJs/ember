  ...
  $("table")
    ...
    .DataTable({
      ...
      ajax: function (data, callback, settings) {
        ...
        axios
          .get("/product-gestion/destination/", {
            params: {
...
$("#modal-eliminar-elemento").on("show.bs.modal", function (event) {
  ...
  modal
    .find(".modal-body")
    .text("¿Desea eliminar al destino: " + dataName + "?");
});
...
function function_delete(selected_id) {
  ...
  axios
    ...
    .then((response) => {
      Toast.fire({
        icon: "success",
        title: "El destino seleccionado se eliminó correctamente",
      });
    ...
    .catch((error) => {
      Toast.fire({
        icon: "error",
        title: "El destino seleccionado no se eliminó",
      });
    });
}
